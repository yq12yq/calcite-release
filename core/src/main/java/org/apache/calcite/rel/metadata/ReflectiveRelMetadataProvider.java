...
public class ReflectiveRelMetadataProvider
  ...
  //~ Instance fields --------------------------------------------------------
  private final ConcurrentMap<Class<RelNode>, Function<RelNode, Metadata>> map;
  ...
  protected ReflectiveRelMetadataProvider(
      ConcurrentMap<Class<RelNode>, Function<RelNode, Metadata>> map,
  ...
  private static RelMetadataProvider reflectiveSource(final Object target,
    ...
    final ConcurrentMap<Class<RelNode>, Function<RelNode, Metadata>> methodsMap =
